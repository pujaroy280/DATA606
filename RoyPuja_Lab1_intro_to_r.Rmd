...
**The line plot is displaying an increase of girls baptized from over the years from 1629-1710**
...
**The proportion of boys born over time were decreasing.**
...
```{r}
df <- unique(present$year)
NROW(present); NCOL(present)
```

**Years included in this dataset range from 1940-2002. The dimensions include 63 observations (rows) of 3 variables (columns). The variables include year, boys and girls.**
...
**The values are greatear than Arbuthnot's and they are of a similar magnitude by 3.**
...
**Based on the present birth records data, the boy_ratio is decreasing over time.**
...
**1961 had the most total number of births in the U.S.**
